...
QString SH85PeriodicSelfCheckTask3::currentState() const
{
    switch (state()) {
...
void SH85PeriodicSelfCheckTask3::start()
{
    ...
    QTimer::singleShot(10000, this, [this]() {
        ...
        // 周期间隔叠加 checker 总时长，降低周期触发与上一轮执行重叠的概率。
...
void SH85PeriodicSelfCheckTask3::startAvailableDeviceChecks()
{
    ...
    m_roundContext.beginRound(roundId, currentTimestamp(), orderedQrcodes);
